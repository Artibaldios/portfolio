...
const AnimatedBackground = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-500/30 via-purple-50/20 to-pink-50/30 dark:from-blue-350/30 dark:via-purple-950/20 dark:to-purple-200/30" />
      ...
      <svg className="absolute inset-0 w-full h-full">
        ...
        <defs>
          <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="rgba(246, 59, 59, 1)" />
