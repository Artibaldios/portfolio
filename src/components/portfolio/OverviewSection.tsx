                ...
                <div className="space-y-4 md:space-y-6">
                  <div>
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-gray-900 dark:text-white flex items-center gap-2 md:gap-3">
                      ...
                      Hello, I&apos;m Artyom Borisevich
                    </h3>
                    <p className="text-base md:text-lg lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-4 md:mb-6">
                      A passionate <span className="font-bold text-blue-600 dark:text-blue-400">Front-end Developer</span> and
                      <span className="font-bold text-purple-600 dark:text-purple-400">
                        &nbsp; AI enthusiast</span> with
                      <span className="font-bold text-green-600 dark:text-green-400"> 3+ years</span> of experience in software development
                    </p>
                  </div>

                  {/* Expanded About Content */}
                  <div className="space-y-4 md:space-y-4 border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                    <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                      Beyond work, I love exploring emerging technologies, contributing to open-source projects.
                  ...
                  <div className="border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                    ...
                    <div className="flex flex-wrap gap-2 md:gap-3">
                      {[ "HTML", "JS", "CSS","React", "Next.js", "TypeScript", "Node.js", "Docker", "UI/UX Design", "AI", "GIT"].map((skill, index) => (
                        <motion.span
                          key={skill}
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                    <div className="p-2 md:p-3 bg-blue-500 rounded-lg md:rounded-xl shadow-lg">
                      <Icon icon="streamline:customer-support-1-solid" className="text-white w-5 md:w-6 h-5 md:h-6" width={24} height={24} />
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white text-base md:text-lg">Tech Support Specialist</h4>
                      <p className="text-blue-600 dark:text-blue-400 font-medium text-sm md:text-base">XB Software</p>
                      <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">2021 —2022</p>
                    </div>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
                    Provided frontline technical support and troubleshooting for clients using company-developed widgets,
                    ensuring timely resolution of hardware and software issues
                  </p>
                  <div className="flex items-center gap-2 text-xs md:text-sm mt-auto">
                    ...
                    <span className="font-semibold text-green-600 dark:text-green-400">Top Rated • 92% Success Score</span>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                    <div className="p-2 md:p-3 bg-green-500 rounded-lg md:rounded-xl shadow-lg">
                      <Icon icon="ic:outline-work-outline" className="text-white w-5 md:w-6 h-5 md:h-6" width={24} height={24} />
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white text-base md:text-lg">Front-end Developer</h4>
                      <p className="text-green-600 dark:text-green-400 font-medium text-sm md:text-base">XB Software</p>
                      <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">2023 — Present</p>
                    </div>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
                    Provided debugging and technical support for time management components, developed and implemented new features,
                    updated legacy codebases with modern web standards.
                  </p>
                  <div className="flex items-center gap-2 text-xs md:text-sm mt-auto">
                    <Icon icon="solar:shield-check-bold" className="text-blue-500 w-3 md:w-4 h-3 md:h-4" width={16} height={16} />
                    <span className="font-semibold text-blue-600 dark:text-blue-400">Time management Specialist</span>
                  </div>
                </motion.div>
              </div>
            </div>
          ...
          <motion.div variants={itemVariants} className="lg:col-span-4 space-y-6 mt-6 lg:mt-0">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50/90 to-pink-50/90 dark:from-purple-950/30 dark:to-pink-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="p-1 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl group-hover:from-orange-600 group-hover:to-red-600 transition-all shadow-md">
                    <Icon icon="solar:letter-bold" className="text-white w-4 h-4" width={16} height={16} />
                  </div>
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white break-all">artibaldios@gmail.com</div>
                  </div>
                </motion.a>

                <motion.div
                  whileHover={{ scale: 1.02, x: 4 }}
                  className="flex items-center gap-3 p-3 rounded-lg bg-white/70 dark:bg-gray-800/30 border border-white/20 dark:border-gray-700/30 cursor-pointer"
                >
                  <Link href="https://t.me/artibaldi" className="flex items-center gap-3">
                    <Icon icon="logos:telegram" className="text-white rounded-xl" width={24} height={24} />
                    <div>
                      <div className="text-sm font-bold text-gray-900 dark:text-white">@artibaldi</div>
                    </div>
                  </Link>
                </motion.div>
                ...
                >
                  <div className="p-1 bg-gradient-to-r from-red-500 to-pink-500 rounded-xl shadow-md dark:border-gray-700/30">
                    <Icon icon="solar:map-point-bold" className="text-white w-4 h-4" width={16} height={16} />
                  </div>
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">Minsk, Belarus</div>
                  </div>
                </motion.div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-amber-50/90 to-yellow-50/90 dark:from-amber-950/30 dark:to-yellow-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-4">
                {[
                  { icon: "solar:star-bold", text: "awarded by company", color: "text-yellow-600" },
                  { icon: "solar:cpu-bolt-bold-duotone", text: "Participated in hackathon", color: "text-blue-600" }
